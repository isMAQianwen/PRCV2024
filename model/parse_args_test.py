...
def parse_args():
    ...
    parser.add_argument('--dataset', type=str, default='WideIRSTD',
                        help='dataset name: NUDT-SIRST, NUAA-SIRST,IRSTD-1k, NUST-SIRST')
    parser.add_argument('--st_model', type=str, default='IRSTD-UIU-oneflow',
                        help='NUDT-SIRST_DNANet_31_07_2021_14_50_57_wDS,'
                             'NUAA-SIRST_DNANet_28_07_2021_05_21_33_wDS')
    parser.add_argument('--model_dir', type=str,
                        default = 'DNA_GAME_oneflow.tar',
    ...
    # ROC threshold
    parser.add_argument('--ROC_thr', type=int, default=100,
                        help='crop image size')
